...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createStore$combineReducers = __webpack_require__(1);

	var _NameReducer = __webpack_require__(23);

	var _NameReducer2 = _interopRequireDefault(_NameReducer);

	var _AgeReducer = __webpack_require__(25);

	var _AgeReducer2 = _interopRequireDefault(_AgeReducer);

	var _INITIAL_STATE = __webpack_require__(24);

	var reducers = _createStore$combineReducers.combineReducers({
	    nameState: _NameReducer2['default'],
	    ageState: _AgeReducer2['default']
	});

	var store = _createStore$combineReducers.createStore(reducers, _INITIAL_STATE.INITIAL_STATE);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function NameReducer(_x, action) {
	    var state = arguments[0] === undefined ? _INITIAL_STATE.INITIAL_STATE : arguments[0];
